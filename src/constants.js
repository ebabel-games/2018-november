...
module.exports = {
  ...
  platforms: [
    [400, 584, 32 * 25, 32, 1],
    [590 - (32 * 7 / 2) - (32 / 2), 435, 32, 32, 0],
    [590, 435, 32 * 7, 32, 1],
    [590 + (32 * 7 / 2) + (32 / 2), 435, 32, 32, 2],
    [400 - (32 * 3 / 2) - (32 / 2), 282, 32, 32, 0],
    [400, 282, 32 * 3, 32, 1],
    [400 + (32 * 3 / 2) + (32 / 2), 282, 32, 32, 2],
    [736 - (32 * 2 / 2) - (32 / 2), 252, 32, 32, 0],
    [736, 252, 32 * 2, 32, 1],
    [736 + (32 * 2 / 2) + (32 / 2), 252, 32, 32, 2],
    [16, 340, 32, 32, 0],
    [48, 340, 32, 32, 1],
    [80, 340, 32, 32, 2],
    [188, 240, 32, 32, 0],
